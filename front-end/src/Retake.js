...
function Retake() {
    ...
    const fetchSurveyData = async () => {
        try {
            const response = await axios.get('http://167.99.54.107:3001/retake', {
                headers: {
            ...
            if (response.data) {
                ...
                setGenderPref(response.data.preferences.gender)
                setYearPref(response.data.preferences.year)
                setPetsPref(response.data.preferences.pets)
                setGuestsPref(response.data.preferences.guests)
                setSmokePref(response.data.preferences.smoke)
                setDrinkPref(response.data.preferences.drink)
                setBedPref(response.data.preferences.bedtime)
                setQuietPref(response.data.preferences.quietness)
                setCleanPref(response.data.preferences.cleanliness)
            } else {
    ...
    const handleSubmit = async () => {
        ...
        if (
            ...
            try {
                const response = await axios.post('http://167.99.54.107:3001/retake', surveyData, {
                    headers: {
